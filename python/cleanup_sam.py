...
def sam():
    ...
    while PC != 0:
        ...
        match PC:
            case 0x2000:
                # 2000: 0x68        PLA
                raise NotImplementedError("Opcode 0x68 not implemented.")
            case 0x2001:
                # 2001: 4C 14 21    JMP $2114
                PC = 0x2114
                clocks += 3
            case 0x2004:
            ...
            case 0x2007:
                ...
                raise NotImplementedError("Opcode 0x68 not implemented.")
            case 0x2008:
                # 2008: 4C 08 47    JMP $4708
                PC = 0x4708
                clocks += 3
            case 0x200b:
                # 200B: 4C 0B 47    JMP $470B
                PC = 0x470b
                clocks += 3
            case 0x2114:
                # 2114: 20 B7 21    JSR $21B7
                push_word(PC + 2)
                PC = 0x21b7
                clocks += 6
            case 0x2117:
                # 2117: A5 CB       LDA $CB
                operand = read_byte(0xcb)
            ...
            case 0x21ea:
                ...
                if not Z:
                    ...
                    clocks += 2
            case 0x21ec:
                # 21EC: 4C 0C 22    JMP $220C
                PC = 0x220c
                clocks += 3
            case 0x21ef:
                # 21EF: A5 CE       LDA $CE
                operand = read_byte(0xce)
                set_a_register(operand)
                PC += 2
                clocks += 3
            case 0x21f1:
                # 21F1: C5 84       CMP $84
                operand = read_byte(0x84)
                compare(A, operand)
                PC += 2
                clocks += 3
            case 0x21f3:
            ...
            case 0x21f5:
                # 21F5: A5 CF       LDA $CF
                operand = read_byte(0xcf)
                set_a_register(operand)
                PC += 2
                clocks += 3
            case 0x21f7:
                # 21F7: C5 85       CMP $85
                operand = read_byte(0x85)
                compare(A, operand)
                PC += 2
                clocks += 3
            case 0x21f9:
            ...
            case 0x2207:
                ...
                operand = read_byte(0xcf)
                value = (operand + 1) & 0xff
                write_byte(0xcf, value)
                update_nz_flags(value)
                PC += 2
                clocks += 5
            case 0x2209:
                # 2209: 4C CF 21    JMP $21CF
                PC = 0x21cf
                clocks += 3
            case 0x220c:
                # 220C: 0x18        CLC
            ...
            case 0x220f:
                # 220F: 26 CC       ROL $CC
                raise NotImplementedError("Opcode 0x26 not implemented.")
            case 0x2211:
                # 2211: 06 CB       ASL $CB
                operand = read_byte(0xcb)
                value = (operand << 1) & 0xff
            ...
            case 0x2220:
                # 2220: A5 CC       LDA $CC
                operand = read_byte(0xcc)
                set_a_register(operand)
                PC += 2
                clocks += 3
            case 0x2222:
                # 2222: 65 87       ADC $87
                operand = read_byte(0x87)
                add_with_carry(operand)
                PC += 2
                clocks += 3
            case 0x2224:
            ...
            case 0x2244:
                ...
                clocks += 6 if different_pages(abs_address, base_address) else 5
            case 0x2246:
                # 2246: 99 14 20    STA $2014,y
                abs_address = 0x2014 + Y
                write_byte(abs_address, A)
                PC += 3
                clocks += 5  # sim65 is incorrect here. No extra cycle should be added when crossing a page boundary.
            case 0x2249:
            ...
            case 0x224a:
                # 224A: C4 CD       CMP $CD
                raise NotImplementedError("Opcode 0xc4 not implemented.")
            case 0x224c:
                # 224C: D0 F6       BNE $2244
                if not Z:
                    PC = 0x2244
